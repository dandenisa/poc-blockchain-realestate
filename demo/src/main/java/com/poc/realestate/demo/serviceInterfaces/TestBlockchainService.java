...
public class TestBlockchainService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TestBlockchainService.class);

    @Autowired
    Web3j web3j;

    public TestBlockchainTransaction process(TestBlockchainTransaction trx) throws IOException {
